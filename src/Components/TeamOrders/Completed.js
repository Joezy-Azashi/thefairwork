...
function Completed() {
  ...
  const getOrders = async (pageNumberSelected = 1) => {
    ...
    Api()
      .post(`/team/get-orders/${completed}/${pageNumberSelected}`, data)
      .then((response) => {
        setIsReady(true);
        ...
        newCounts['Completed'] = response?.data.count
  ...
  const clientGetOrders = async (pageNumberSelected = 1) => {
    ...
    Api()
      .post(`/team/get-orders/${completed}/${userAccountId}/${pageNumberSelected}`, data)
      .then((response) => {
        setIsReady(true);
        setOrders(response?.data?.data);
        setpageLength(response?.data?.pages);
            ...
            <div className="d-flex justify-content-center align-item-center mt-5">
              ...
              <div className="row text-center">
                <div className="col-md-12 mt-4">
                  ...
                  <div className="d-flex justify-content-center align-item-center mt-5">
                    <p>
                    There are no completed hires currently.
                    </p>
                  </div>
                </div>
              </div>
