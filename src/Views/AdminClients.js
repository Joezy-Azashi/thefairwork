...
import { recruiterAccountType } from "../Services/userTypes";
...
const AntSwitch2 = withStyles((theme) => ({
  root: {
    width: 40,
    height: 20,
    paddingTop: 0,
...
function AdminClients() {
  ...
  const [isLimited, setisLimited] = useState(getCurrentUser());
  ...
  const togglePilot = (index, pageNumberSelected = 1) => {
    const accountId = recruiter?.data[index]?.id;
    const data = {
      isLimited: !recruiter?.data[index]?.isLimited,
    };
    Api()
      .put(`/admin/update-toggle/${accountId}`, data)
      .then(async (response) => {
        GetRecruiters(pageNumber);
      })
      .catch((error) => {});
                  ...
                  <StyledTableRow>
                    ...
                    <StyledTableCell>
                      <Grid component="label" container alignItems="center">
                        ...
                        <Grid item className="toggleLabelStatus">
                    ...
                    <StyledTableCell>
                      <Grid container alignItems="center">
                        ...
                        <Grid item className="toggleLabelPilot">
                          <span style={{ fontSize: "14px" }}>
                            {!recruiters.isLimited ? `On` : `Off`}
                          </span>
                        </Grid>
                      </Grid>
                    </StyledTableCell>
