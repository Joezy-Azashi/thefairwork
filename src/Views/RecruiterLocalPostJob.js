...
import { localPostJob } from "../Services/redux/postJob/index";
...
function RecruiterLocalPostJob() {
  ...
  const recruiterLocalPostJob = async (e) => {
    e.preventDefault();
    const data = {
    ...
    if (data.status === "Draft") {
      setloading(true);
      await dispatch(localPostJob(data))
        .then(async (response) => {
          setloading(false);
      ...
      setAlert({
        open: true,
        message:
          "All fields are required except salary, file upload and questions",
        severity: "error",
      });
      setOpen(true);
    } else {
        ...
        <div className="col-md-12 d-flex justify-content-center">
          ...
          >
            <CardContent>
              ...
              <form onSubmit={recruiterLocalPostJob}>
                <div className="row">
                ...
                <div className="row">
                  <div className="col-md-4 d-flex justify-content-start mb-3">
                    ...
                    >
                      <label for="jobsetting-type1" style={{ width: "100%" }}>
                        <div class="d-flex justify-content-end">
                          <input
                            type="radio"
                            id="jobsetting-type1"
                  ...
                  <div className="col-md-4 d-flex justify-content-center mb-3">
                    ...
                    >
                      <label for="jobsetting-type2" style={{ width: "100%" }}>
                        <div class="d-flex justify-content-end">
                          <input
                            type="radio"
                            id="jobsetting-type2"
                  ...
                  <div className="col-md-4 d-flex justify-content-end mb-3">
                    ...
                    >
                      <label for="jobsetting-type3" style={{ width: "100%" }}>
                        <div class="d-flex justify-content-end">
                          <input
                            type="radio"
                            id="jobsetting-type3"
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    <TextField
                      ...
                      fullWidth
                      className=""
                      value={category === "" ? freelancerCategory : category}
                      style={{ textTransform: "capitalize" }}
                      onChange={(e) => {
...
export default RecruiterLocalPostJob;
